...
export class SidebarComponent implements OnInit {
  ...
  constructor(private navService: NavService, private router:Router,private layout: LayoutService, private authService: AuthService) {
  ...
  checkTheUser(data:any){
    if(data.account_type ){
      return data.account_type != this.accountType ? false : true;
    }
    return true;
  }
}