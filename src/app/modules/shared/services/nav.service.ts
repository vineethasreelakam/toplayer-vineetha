...
export class NavService {
  ...
  MENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      active: false,
      children: [
        { path: "/user/account/change-password", title: "Change Password", type: "link",  },
        { path: "/user/account/sub-account/list", title: "Add Sub Account", type: "link", account_type:'1'},
    ...
    },
    {
      ...
      active: false,
      children: [
        { path: "/user/plan", title: "Plan", type: "link" },
      ],
    },
    {
      title: "Connect",
      ...
      active: false,
      children: [
        { path: "/user/connect", title: "Connect", type: "link" },
        // { path: "/profile/appearance", title: "Appearance", type: "link" },
        // { path: "/profile/my-profiles", title: "My Profiles", type: "link" },
      ],
    },
    {
      title: "Events",
      ...
      active: false,
      children: [
        { path: "/user/event", title: "Event", type: "link" },
        // { path: "/profile/appearance", title: "Appearance", type: "link" },
        // { path: "/profile/my-profiles", title: "My Profiles", type: "link" },
      ],
    },
    {
      ...
      active: false,
      children: [
        { path: "/user/wedding", title: "Wedding", type: "link" },
        // { path: "/profile/appearance", title: "Appearance", type: "link" },
        // { path: "/profile/my-profiles", title: "My Profiles", type: "link" },
      ],
    },
